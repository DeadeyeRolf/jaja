...
if(q2stage == -1)
{
sendQuest("@gre@Your Scape", 7333);
}
if(q2stage >= 1)
{
sendQuest("@yel@Your Scape", 7333);
}
if(q2stage == 0)
{
sendQuest("@yel@Your Scape", 7333);
...
ReplaceItems(565, 565); // Xerozcheez: Replaces ectos with blood runes
ScanItems(); // Xerozcheez: Catches dupers
                ...
                //hasegg = 1;
                /*END OF DROP*/
                sendQuest("Thanks for playing Your Scape!", 2450);
